  ...
  return (
    <div className="ooda-page">
      <div className="ooda-card">
        {/* Верхня кнопка Назад */}
        <button type="button" className="ooda-back-top" onClick={onBack}>
          ← Назад
        </button>
        ...
        <p className="ooda-text">
          ...
          дії. Важливо як приймати рішення, а й оперативно втілювати в життя.
        </p>

        {/* Схема циклу OODA — повна ширина карти */}
        <img
          src={oodaCycle}
          alt="Схема циклу OODA"
          className="ooda-image-full"
        />
        ...
        {/* Цитата + обкладинка Сунь-цзи з боковим розташуванням на десктопі */}
        <div className="ooda-quote-block">
          <div className="ooda-quote-image-wrap">
            <img
              src={sunTzu}
              alt="Обкладинка «Мистецтво війни» Сунь-цзи"
              className="ooda-image-side"
            />
          </div>
          <p className="ooda-text ooda-quote-text">
            «Війна – це шлях обману. Тому, якщо ти й можеш що-небудь, показуй
            супротивнику ніби не можеш; якщо ти й користуєшся чим-небудь –
            показуй йому ніби ти цим не користуєшся; хоч би ти й перебував
            близько – показуй, ніби ти далеко; хоч би ти й перебував далеко –
            показуй що ти близько; заманюй його вигодою; доведи його до розладу
            та бери його; якщо у нього все повно, будь напоготові; якщо він
            сильний,  - ухиляйся від нього; викликавши у нього гнів – доведи
            його до стану розладу; вдавши сумирність – виклич в ньому
            бундючність; якщо його сили свіжі – втоми його; якщо у нього
            дружні воїни – роз’єднай; нападай на нього, коли він не готовий;
            виступай, коли він не чекає.»
          </p>
        </div>

        {/* Нижня кнопка запуску тренажера OODA */}
